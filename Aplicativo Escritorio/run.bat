...
set "CLASSPATH=.;..\%LIB_DIR%\jcalendar-1.4.jar;..\%LIB_DIR%\sqlite-jdbc-3.45.1.0.jar;..\%LIB_DIR%\slf4j-api-1.7.36.jar;..\%LIB_DIR%\slf4j-nop-1.7.36.jar;..\%LIB_DIR%\itextpdf-5.5.13.3.jar;..\%LIB_DIR%\jakarta.activation-2.0.1.jar;..\%LIB_DIR%\jakarta.mail-2.0.1.jar"

echo [+] Creando directorio de binarios...
if not exist "%BIN_DIR%" mkdir "%BIN_DIR%"

echo [+] Compilando proyecto...
javac -cp ".;%LIB_DIR%\jcalendar-1.4.jar;%LIB_DIR%\sqlite-jdbc-3.45.1.0.jar;%LIB_DIR%\slf4j-api-1.7.36.jar;%LIB_DIR%\slf4j-nop-1.7.36.jar;%LIB_DIR%\itextpdf-5.5.13.3.jar;%LIB_DIR%\jakarta.activation-2.0.1.jar;%LIB_DIR%\jakarta.mail-2.0.1.jar" ^
    -d "%BIN_DIR%" ^
    -sourcepath "%SRC_DIR%" ^
